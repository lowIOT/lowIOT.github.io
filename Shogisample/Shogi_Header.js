function Shogi_Header(app, ui_listener) {
    Shogi_Component.call(this, app, ui_listener);
    this.turn_num_label_text = app.text_res['turn_num_label'];
}

Shogi_Header.prototype = Object.create(Shogi_Component.prototype);
Shogi_Header.prototype.constructor = Shogi_Header;

Shogi_Header.prototype.createElement = function() {
    this.element = document.createElement('div');
    this.element.style.position = 'absolute';
    this.setBackground('#ffffcc');
    this.start_button = new Shogi_Button(this.app, this);
}

Shogi_Header.prototype.onRectSetted = function() {
...
Shogi_Header.prototype.onListeningComponentClicked = function(comp, x, y) {
    if (comp == this.start_button) {
        this.app.onStartButtonClicked.call(this.app);
    }
}

Shogi_Header.prototype.setGame = function(game) {
    this.game = game;
}

Shogi_Header.prototype.setBackground = function(bg) {
    Shogi_Component.prototype.setBackground.call(this, bg);
    this.element.style.background = this.background;
}

Shogi_Header.prototype.update = function() {
    if (this.game) {
